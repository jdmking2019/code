...
src_dir = "/media/jdmking/JDM/ERROR_IMG/door"
filename = os.listdir(src_dir)
xml_dir = "/media/jdmking/JDM/ERROR_IMG/ann_door"
# src_path = [os.path.join(src_dir,filename) for filename in os.listdir(src_dir)]
Growth_size = 30

def Write_xml(x_min,y_min,x_max,y_max,filename,width,height):
    ...
    etree.SubElement(key_object, "name").text = "door"
